...
110 PRINT"MEANING."
130 PRINT:PRINT"I CHOOSE A WORD.":PRINT"YOU TYPE A SYNONYM."
140 PRINT:PRINT"IF YOU CAN'T THINK OF A SYNONYM, TYPE THE WORD 'HELP' OR 'H' ";
145 PRINT"AND I WILL TELL YOU A SYNONYM."
147 GOSUB 9030
150 CLS:RESTORE:C=C+1:READ N
160 IF C>N THEN 420
...
250 IF LEFT$(A$,1)="H" OR LEFT$(A$,1)="H" THEN 340: REM BUG
260 FOR K=1 TO N2
270 IF G=K THEN 290
280 IF A$=W$(K) THEN 320
290 NEXT K
300 PRINT "- TRY AGAIN.": GOTO 240
320 PRINT R$(INT(RND(1)*5+1)):GOSUB 1030:GOTO 150
