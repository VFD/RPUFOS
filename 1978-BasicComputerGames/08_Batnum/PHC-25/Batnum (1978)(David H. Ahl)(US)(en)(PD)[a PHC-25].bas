...
380 IF N<1 THEN 220
390 PRINT:INPUT"ENTER WIN OPTION - 1 TO TAKE LAST, 2 TO AVOID LAST: ";M
410 IF M=1 THEN 430
420 IF M<>2 THEN 390
430 PRINT:INPUT"ENTER MIN AND MAX ";A,B
450 IF A>B THEN 430
460 IF A<1 THEN 430
470 IF A<>INT(A) THEN 430
480 IF B<>INT(B) THEN 430
490 PRINT:INPUT"ENTER START OPTION - 1 COMPUTER FIRST, 2 YOU FIRST ";S
500 PRINT
510 IF S=1 THEN 530
520 IF S<>2 THEN 490
530 C=A+B
