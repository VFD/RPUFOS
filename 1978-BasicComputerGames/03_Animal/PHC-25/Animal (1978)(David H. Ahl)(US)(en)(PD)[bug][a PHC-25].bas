5 SCREEN 1,1,1
10 PRINT TAB(12);"ANIMAL"
20 PRINT TAB(7);"CREATIVE COMPUTING"
30 PRINT TAB(5);"MORRISTOWN, NEW JERSEY"
35 PRINT
...
210 INPUT A$
220 A$=LEFT$(A$,1)
230 IF A$="Y" OR A$="Y" THEN PRINT "WHY NOT TRY ANOTHER ANIMAL?": GOTO 120
...
290 INPUT A$
300 A$=LEFT$(A$,1): IF A$<>"Y" AND A$<>"N" AND A$<>"Y" AND A$<>"N" THEN 280
310 IF A$="Y" THEN B$="N"
320 IF A$="N" THEN B$="Y"
330 Z1=VAL(A$(0))
340 A$(0)=STR$(Z1+2)
