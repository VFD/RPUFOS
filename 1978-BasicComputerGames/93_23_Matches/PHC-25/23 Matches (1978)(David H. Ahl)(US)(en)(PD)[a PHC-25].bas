10 GOSUB 9000
20 PRINT TAB(11);"23 MATCHES"
30 PRINT TAB(7);"CREATIVE COMPUTING":PRINT TAB(5);"MORRISTOWN, NEW JERSEY"
40 PRINT
80 PRINT TAB(5);"THIS IS A GAME CALLED":PRINT TAB(11);"23 MATCHES"
90 PRINT
