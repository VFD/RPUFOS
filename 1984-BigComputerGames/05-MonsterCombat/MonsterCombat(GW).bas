...
40 REM MICROSOFT VERSION BY CHRIS VOGELI
50 CLS:PRINT "*** GIANT MONSTER ATTACK"
60 DIM E(10,10),B(10,10),M(11),M$(11),N(11),T$(11),P(11),G$(3)
70 DIM C(15),D(15)
80 FOR I=1 TO 11:READ M$(I),T$(I),M(I),P(I):NEXT I
90 GOSUB 3500:V=INT(RND(1)*3):GOSUB 3500
100 C=INT(RND(1)*1501+500):GOSUB 3500:S=INT(RND(1)*6):GOSUB 3500:R=INT(RND(1)*4)
110 G$(1)="SLEEP SPELL":G$(2)="CHARM":G$(3)="INVISIBILITY SPELL"
120 PRINT:PRINT "DO YOU WANT TO USE THE STRENGTH AND MAGIC FROM A"
130 INPUT "PREVIOUS GAME (Y OR N) ";X$:IF X$="Y" THEN 3210
140 D=C:V1=V:S1=S:R1=R:PRINT:PRINT "PLEASE WAIT..."
150 FOR I=1 TO 10:FOR J=1 TO 10
160 GOSUB 3500:T=INT(RND(1)*10):IF T<>1 OR CS=15 THEN T=0
170 GOSUB 3500:H=INT(RND(1)*2):GOSUB 3500:W=INT(RND(1)*10):GOSUB 3500:P=INT(RND(1)*51)
180 A(I,J)=10000*T+100*P+10*W+H
190 IF T=1 THEN CS=CS+1:C(CS)=I:D(CS)=J
200 NEXT J:NEXT I:T=0
210 GOSUB 3500:X1=INT(RND(1)*8)+2:GOSUB 3500:Y1=INT(RND(1)*8)+2
220 GOSUB 3500:X=INT(RND(1)*10)+1:GOSUB 3500:Y=INT(RND(1)*10)+1
230 IF X1<1 OR X1>10 OR Y1<1 OR Y1>10 THEN 2330
240 FOR I=1 TO 10:FOR J=1 TO 10:B(I,J)=0:NEXT J:NEXT I
250 CA=INT(A(X1,Y1)/10000):P=INT(((A(X1,Y1)-(10000*CA))/100))
260 W=INT((A(X1,Y1)-(10000*CA)-(100*P))/10)
270 H=A(X1,Y1)-10000*CA-100*P-10*W:I=0:J=0
280 GOSUB 3500:IF CA=1 THEN I=INT(RND(1)*10+1):GOSUB 3500:J=INT(RND(1)*10+1):B(I,J)=7
290 IF CA=1 AND I=X AND Y=J THEN B(I,J)=0:GOTO 280
300 IF H=1 THEN GOSUB 3500:I=INT(RND(1)*10+1):GOSUB 3500:J=INT(RND(1)*9+1)
310 IF H=1 AND B(I,J)<>0 THEN 300
320 IF H=1 THEN B(I,J)=3
330 B(X,Y)=5:IF W=0 THEN 380
340 FOR I=1 TO W
350 GOSUB 3500:J=INT(RND(1)*10)+1:GOSUB 3500:K=INT(RND(1)*10)+1
360 IF B(J,K)<>0 THEN 350
370 B(J,K)=2:NEXT I
380 IF P=0 THEN 430
390 FOR I=1 TO P
400 GOSUB 3500:J=INT(RND(1)*10)+1:GOSUB 3500:K=INT(RND(1)*10)+1
410 IF B(J,K)<>0 THEN 400
420 B(J,K)=1:NEXT I
430 FOR I=1 TO 10:FOR J=1 TO 10
440 IF B(J,I)=0 THEN PRINT "T";
450 IF B(J,I)=1 THEN PRINT "-";
460 IF B(J,I)=2 THEN PRINT "I";
470 IF B(J,I)=3 THEN PRINT "^";
480 IF B(J,I)=5 THEN PRINT "O";
490 IF B(J,I)=7 THEN PRINT "M";
...
610 GOSUB 3500:I=INT(RND(1)*5):IF I=2 THEN GOSUB 2800
620 IF I=1 AND T<>9 THEN PRINT "THERE'S NOTHING HERE.":GOTO 1270
630 IF I=1 AND T=9 THEN 1260
640 GOSUB 3500:I=INT(RND(1)*16+1):N=I:IF I=12 THEN 2040
650 IF I=13 THEN 2080
660 IF I=14 THEN 2120
670 IF I>14 THEN J=100:GOTO 720
680 GOSUB 3500:J=INT(RND(1)*100/M(I)):N1=J:IF J=0 THEN J=1:N1=J
690 IF J=1 THEN M$=M$(I):PRINT "A ";M$;" IS GUARDING ";
700 IF J<>1 THEN M$=M$(I)+"S":PRINT J;M$;" ARE GUARDING ";
710 M=M(I)*J:GOSUB 3500:I=INT(RND(1)*14+1)
...
760 PRINT T$(I):P=P(I)
770 IF M$=M$(11) AND M1=7 THEN 2030
780 IF J=100 THEN PRINT "YOU GET THE TREASURE FREE!":GOTO 1190
790 PRINT "DO YOU WISH TO (1)FIGHT, (2)RUN, (3)BRIBE, OR";
800 INPUT " (4)CAST A SPELL";K
...
850 GOSUB 3500:I=INT(RND(1)*1001):L=2:C=C-K:K=K-.01*Q
...
940 GOSUB 3500:I=INT(RND(1)*12):IF I=11 THEN 890
950 FOR H=0 TO 10:IF H*10=>M AND H<=I THEN 970
960 NEXT H:GOTO 1150
970 A=X:B=Y:K=0:T=0:GOSUB 3500:C=C-INT((RND(1)*21)+.001*Q)-5
980 GOSUB 3500:X=A+INT(RND(1)*3)-1:GOSUB 3500:Y=B+INT(RND(1)*3)-1
990 IF X=A AND Y=B THEN 980
1000 DA=DA+.1:IF X>10 THEN X=1:X1=X1+1:K=1
1010 IF Y>10 THEN Y=1:Y1=Y1+1:K=1
1020 IF X<1 THEN X=10:X1=X1-1:K=1
1030 IF Y<1 THEN Y=10:Y1=Y1-1:K=1
1040 IF B(X,Y)>1 AND K=0 THEN 980
1050 GOSUB 3500:B(A,B)=INT(RND(1)*3):B(X,Y)=5:IF I<>11 THEN Z=Z+1
...
1100 GOSUB 3500:I=INT(RND(1)*22):L=0:IF I=21 OR (I>15 AND K<2) THEN 890
...
1190  GOSUB 3500:IF N<12 THEN I=INT(RND(1)*7):IF I=3 THEN 2150
...
1300 GOTO 2500
1310 GOSUB 3500:A1=X1:B1=Y1:A=X:B=Y:C=C-INT(7.5*K*RND(1))
...
1400 IF B(X,Y)=1 THEN C=C-5
1410 IF B(X,Y)=0 THEN C=C-10
1420 IF C<=0 THEN PRINT "YOU DIED FROM LACK OF STRENGTH.";:GOTO 900
1430 IF X1<>A1 OR Y1<>B1 THEN 230
1440 IF B(X,Y)=7 THEN T=9
1450 IF B(X,Y)=2 THEN 1480
1460 IF B(X,Y)=3 THEN 1500
1470 GOSUB 3500:B(A,B)=INT(RND(1)*3):B(X,Y)=5:GOTO 430
1480 PRINT "YOU TRIED TO GO THROUGH A WALL."
1490 GOSUB 3500:C=C-INT(RND(1)*Q*5.000001E-03)-25:X=A:Y=B:GOTO 1270
1500 GOSUB 3500:Y=Y+1:C=D:B(A,B)=INT(RND(1)*3):B(X,Y)=5:T=1:V=V1
1510 R=R1:S=S1:GOSUB 430
1520 PRINT "YOU STOPPED AT AN INN AND REGAINED YOUR STRENGTH."
1530 GOSUB 3500:I=INT(RND(1)*Q*.75):IF I<5 AND Q>5 THEN I=5
1540 IF I<5 AND Q<=5 THEN I=0
1550 PRINT "YOU PAID"I"TREASURE POINTS TO STAY THERE.":Q=Q-I
1560 PRINT "YOU NOW HAVE"Q"TREASURE POINTS."
1570 GOSUB 3500:I=INT(RND(1)*3):IF I=2 THEN 1270
1580 IF I=1 THEN GOSUB 2670:GOTO 1270
1590 GOSUB 3500:I=INT(RND(1)*4+1)
...
1630 PRINT (11-Y1)*100"YARDS TO THE SOUTH.":GOTO 1270
...
1700 ON K GOTO 1710,1790,1850
1710 IF S=0 THEN PRINT "YOU HAVE NO SLEEP SPELLS.":GOTO 1150
1720 IF N=4 THEN PRINT "YOU CAN'T PUT "M$(4)"S TO SLEEP.":S=S-1:GOTO 1150
1730 GOSUB 3500:I=INT(RND(1)*10):S=S-1
...
1860 GOSUB 3500:I=INT(RND(1)*10):V=V-1
...
1890 GOTO 1840
1900 GOSUB 3500:I=INT(RND(1)*2)+1:ON I GOTO 1910,1930
...
1950 GOSUB 3500:J=INT(RND(1)*10):GOSUB 3500:I=INT(RND(1)*10)
...
2290 IF T=7 THEN R=R+1:R1=R1+1
...
2340 PRINT "YOU SURVIVED THE FOREST."
2350 PRINT "DO YOU WANT TO SEE THE NUMBER OF MONSTERS YOU KILLED,"
2360 INPUT "RAN FROM, AND BRIBED (Y OR N) ";X$:IF X$="N" OR X$="n" THEN PRINT:GOTO 2420
2370 PRINT "MONSTER";TAB(11)"# SLAIN";TAB(32)"MONSTER";TAB(43)"# SLAIN"
2380 FOR I=1 TO 5:PRINT M$(I);TAB(14);N(I);TAB(32);M$(I+5);TAB(46);N(I+5)
2400 NEXT I:PRINT TAB(32);M$(11),TAB(46);N(11)
...
2450 PRINT:X$=""
2460 IF D1<30 THEN INPUT "DO YOU WANT TO RETURN TO THE FOREST";X$
2470 REM
...
2550 GOSUB 3500:I=INT(RND(1)*21)*100:GOSUB 3500:J=INT(RND(1)*9):A(X1,Y1)=A(X1,Y1)-10000
2560 PRINT "YOU FOUND"I"TREASURE POINTS THERE.":Q=Q+I:GOSUB 2790
2570 IF J<>7 OR M1=7 THEN 2600
2580 PRINT "YOU ALSO FOUND A MIRROR WHICH WILL KILL ANY "M$(11)"S YOU MEET.":M1=7
2600 GOSUB 3500:J=INT(RND(1)*20):IF J=2 THEN C=2*C
2610 IF J=2 THEN PRINT "YOU ALSO FOUND AN ENCHANTED SWORD WHICH DOUBLES YOUR STRENGTH."
2630 FOR I=1 TO CS-1:IF C(I)<>X1 THEN 2650
2640 FOR J=1 TO CS-1:C(J)=C(J+1):D(J)=D(J+1):NEXT J
2650 NEXT I:CS=CS-1:IF CS=0 THEN PRINT "YOU FOUND THE LAST OF THE CASTLES."
2660 RETURN
2670 IF CS=0 THEN RETURN
2680 GOSUB 3500:I=INT(RND(1)*CS+1)
2690 PRINT "THE INNKEEPER TOLD YOU OF A LEGEND OF A CASTLE"
2700 IF C(I)=X1 AND D(I)=Y1 THEN PRINT "VERY CLOSE BY.":RETURN
2710 J=X1-C(I):I=Y1-D(I)
...
2780 PRINT:RETURN
2790 REM
2800 GOSUB 3500:I=INT(RND(1)*11+1)
2810 ON I GOTO 2820,2860,2840,2890,2920,2950,2970,2990,3010,3020,3050
2820 GOSUB 3500:I=INT(RND(1)*10+1):PRINT "YOU STEPPED INTO A TIME WARP AND LOST"I"DAYS."
2830 D1=D1+I:RETURN
2840 GOSUB 3500:I=INT(RND(1)*10+1):J=D1:D1=D1-I:IF D1<.1 THEN D1=.1:I=J-D1
2850 PRINT "YOU STEPPED INTO A TIME WARP AND GAINED"I"DAYS.":RETURN
2860 IF C=>D THEN RETURN
2870 PRINT "YOU MET AN ELF WITH A MAGIC POTION THAT GAVE"
...
2970 GOSUB 3500:I=INT(RND(1)*50+1):PRINT "YOU FOUND"I"COINS LYING ON THE"
...
3030 PRINT "YOU WANDERED INTO AN AREA WHERE MAGIC DOESN'T WORK."
...
3070 PRINT "CASTLE ";:GOSUB 3500:I=INT(RND(1)*CS)+1:GOSUB 2700:RETURN
3080 FOR I=1 TO 2000:NEXT:PRINT
3090 PRINT "DO YOU WISH TO GO TO A NEW FOREST WITH THE SAME STRENGTH"
3100 INPUT "AND MAGIC";X$:IF X$="y" OR X$="Y" THEN 3190
3110 PRINT "DO YOU WISH TO GO TO A NEW FOREST WITH NEW STRENGTH AND"
3120 INPUT "MAGIC";X$:IF X$="Y" OR X$="y" THEN RUN
3130 PRINT "DO YOU PLAN ON USING THE SAME STRENGTH AND MAGIC AGAIN"
3140 INPUT "SOME OTHER TIME (Y OR N) ";X$:IF X$="Y" OR X$="y" THEN 3350
...
3190 BR=0:Z=0:D1=0:FOR I=1 TO 11:N(I)=0:NEXT I:IF Q1<Q THEN Q1=Q
3200 Q=0:GOTO 140
3210 INPUT "COMBAT STRENGTH";C
3220 IF C<500 OR C>2000 THEN 3210
3230 INPUT "SLEEP SPELLS";S:INPUT "CHARMS";R:INPUT "INVISIBILITY";V
3240 INPUT "PREVIOUS LARGEST TREASURE TOTAL";Q1:GOTO 140
3250 IF Q1<Q THEN PRINT "YOU WON MORE TREASURE THIS TIME THAN BEFORE."
3260 IF Q1>Q THEN PRINT "YOU DIDN'T GET AS MUCH TREASURE THIS TIME."
3270 RETURN
3280 PRINT "YOUR MAGIC TOTAL IS RATHER LARGE.  DO YOU WANT TO CONVERT"
3290 INPUT "IT TO COMBAT POINTS";X$:IF X$="N" OR X$="n" THEN RETURN
...
3370 DATA GOBLIN,10 SILVER SPOONS,5,10,MINOTAUR
3380 DATA A SWORD WHICH MIGHT BE ENCHANTED,10,25
3390 DATA CYCLOPS,50 SILVER COINS,20,50,ZOMBIE
3400 DATA 100 GOLD PIECES,30,100,GIANT
3410 DATA AN EXCELLENT BRACELET,40,50,HARPY
3420 DATA A TREASURE CHEST,50,200,GRIFFIN
3430 DATA A PEARL NECKLACE,60,50,CHIMERA
3440 DATA A JEWELED SWORD,70,30,DRAGON
3450 DATA A JAR OF RUBIES,80,75,WYVERN
3460 DATA A BOX OF JEWELS,90,100,BASILISK
3470 DATA A GOLDEN GOBLET,100,50
3480 END
3500 RANDOMIZE(VAL(RIGHT$(TIME$,2))):RETURN
