---
title: "ZX81 : RALP, Langage machine en REM"
author: VincentD
excerpt: "Le langage machine mis dans n'importe quelle ligne REM d'un ZX81."
type: Software
---
...
Lire <a href="{{ site.baseurl }}/library/RALP (1983-09)(Micro Systemes)(FR).pdf" target="_blank">l'article de 2 pages du Micro Systèmes (septembre 1983)</a> PDF et OCR, dans un nouvel onglet.


## Les Listings

Reprise des listings de l'article.
...
À étudier pour nos <i>Obscure Systems</i> et faire les adaptations.\
Le point principal étant de trouver le numéro de la ligne en mémoire.\
RALP c'est pour un ZX81.

Étape :

- Documenter la structure d'une ligne BASIC
- Déterminer le point d'entrée du programme BASIC
...
Pour l'insertion du code LM, un éditeur hexadécimal peut faire l'affaire pour des sous-routines courtes.
La ligne REM avec le nombre d'octet nécessaire, cf. ci-dessus.
